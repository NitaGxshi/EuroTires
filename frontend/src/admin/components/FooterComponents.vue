<template>
    <div class="footer">
        <div class="news-letter">
            <h3>Receive sales notifications</h3>
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>Our Services</h3>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Car</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> SUV</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Truck</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Motor-Home
                </router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Tractor</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Motorcycle</router-link>
            </div>
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/menu"> <i class="fas fa-arrow-right"></i> Services</router-link>
                <router-link @click="scrollToTop()" to="/session"> <i class="fas fa-arrow-right"></i> Book a Session
                </router-link>
            </div>
            ...
            <div class="box">
                ...
                <div v-else>
                    ...
                    <router-link @click="scrollToTop()" to="/admin"><i class="fas fa-arrow-right"></i>admin</router-link>
                </div>
            </div>

            <div class="box">
                <h3>opening hours</h3>
                <p>everyday : 9:00am to 18:00pm</p>
