<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/serv-1.png" alt="" />EuroTires
        </router-link>
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/session">session</router-link>
        </nav>
